...
absolute: make action! [[
		...
		value	 [number! char! pair! time! money!]
		return:  [number! char! pair! time! money!]
	]
...
add: make action! [[
		...
		value1	 [number! char! pair! tuple! vector! time! date! money!]
		value2	 [number! char! pair! tuple! vector! time! date! money!]
		return:  [number! char! pair! tuple! vector! time! date! money!]
	]
...
negate: make action! [[
		...
		number 	 [number! bitset! pair! time! money!]
		return:  [number! bitset! pair! time! money!]
	]
